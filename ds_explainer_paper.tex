...
A RandomForest regressor is paired with SHAP since tree models offer fast explanations and serve as a strong baseline.
\subsection{Metrics}
Performance is measured with MAE while calibration is assessed using the Brier score and Expected Calibration Error (ECE).
