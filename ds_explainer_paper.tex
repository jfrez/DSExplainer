...
These metrics approximate the behavior of belief and plausibility without relying on the full formalism of Dempster--Shafer theory.
...
\begin{table}[H]
    ...
    \begin{tabular}{|l|c|}
        ...
        \texttt{ticket\_x\_cabin\_x\_embarked} & 0.164 \\
        \hline
    \end{tabular}
\end{table}
